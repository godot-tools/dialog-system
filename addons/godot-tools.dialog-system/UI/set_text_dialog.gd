...
const ResponseRow = preload("res://addons/godot-tools.dialog-system/UI/ResponseRow.tscn")
const NewResponseDialog = preload("res://addons/godot-tools.dialog-system/UI/NewResponseDialog.tscn")
