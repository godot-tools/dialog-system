...
const NewConditionDialog = preload("res://addons/godot-tools.dialog-system/UI/NewConditionDialog.tscn")
const ConditionRow = preload("res://addons/godot-tools.dialog-system/UI/ConditionRow.tscn")
